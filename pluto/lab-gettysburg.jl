...
1. *proportion of long words*. We expect a higher proportion of long words in Grand Style than in Plain Style.
2. **-->ADD A SECOND FEATURE HERE.<--**
"""
...
"""Break up a given text into "words" by removing all
punctuation characters, and splitting the remaining text on whitespace.
"""
function words(txt)
	missing
end
...
"""Return true if word is longer than `breakpoint`,
or false if it is not.
"""
function longword(w, breakpoint)
	missing
end
...
@bind cutoff Slider(5:20, show_value = true)
...
lincoln_longscore = nothing # length(lincoln_long) / length(lincoln_words)
...
# These are the X values for the chart
labels = ["Lincoln", "Everett"]

# ╔═╡ 8bd52867-4efb-405e-9a63-46406b4a567e
# These are the Y values
scores = [lincoln_longscore, everett_longscore]

# ╔═╡ 67bb2fb1-e9a7-4940-b67a-b3f5cd689cc6
#= 
	Uncomment the last line of this cell to plot the chart:
=#
...
manifest_format = "2.0"
project_hash = "f55861124df1e68e7e92b9bfc84907dafd872043"
