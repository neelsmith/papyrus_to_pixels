...
# ╔═╡ 4d8ca3b5-3d32-46c1-97d7-054b7ad7356b
#maxParsimonyNet(starttree, df, outgroup = "English")
...
# ╔═╡ 7697e4b1-d279-4448-bf51-f8cd0a8523b3
...
# ╔═╡ 23353d30-cddb-48cf-8e6c-021a166c8b4b
...
# ╔═╡ 1205b182-a761-4ce2-ae73-c61276de48f4
...
# ╔═╡ 5f0afde2-faa5-40ab-9857-d8d604f14d16
...
"""Find parent of a node in a list of source->target pairs."""
function parent(nd, pairings)
	map(filter(pr -> pr[2] == nd, pairings)) do pr
		pr[1]
	end
end
...
# ╔═╡ 04e07918-3a5d-46b7-b0b4-ed5af8a2bec6
opt |> typeof
...
manifest_format = "2.0"
project_hash = "3231fadeaaf96e66d881413b8b03e2acc05507be"
...
git-tree-sha1 = "591aac784c7ea032ac97a53af19cfbfa7e39afaf"
