...
In this notebook, we will look at *n-grams* (that is, sequences of `n` successive terms) in a text.
...
# ╔═╡ 0fd3ec02-b622-43fc-a5b0-ccf015c2f44a
md"""### Settings"""
...
md"""*n-gram size*: $(@bind n Slider(1:15; default=3, show_value=true)) *Number to display*: $(@bind maxdisplay Slider(50 : 10 : 500; default=100, show_value=true))"""

# ╔═╡ 40dee0af-a853-4f62-8bed-8168780160a9
html"""
<br/><br/><br/><br/><br/>
<br/><br/><br/><br/><br/>
"""

# ╔═╡ edb77dcd-534b-4be1-973f-bb5389c0f571
md"""> Compute n-grams"""

# ╔═╡ 9488956a-8361-4347-b8de-9418cf5fff5a
# use join to replace each list of terms with a string joined by "_"
# and map each value of `chunked` to a single string
stringchunks = []

# ╔═╡ c118e227-0efa-4bb5-af15-a7aa1703d83d
freqs_sorted = begin
	# use countmap to get a dictionary of counts
	stringchunks
end

# ╔═╡ b9fff615-7d1e-4d51-9733-de482fb55d60
md"""> Data to plot"""

# ╔═╡ dfbfbf6a-0a98-4929-98f9-97c192d28c31
md"""Collect the keys and values from your dictionary: the values (counts) will be our y values; the keys (n-grams) will be our x values."""

# ╔═╡ 9d271ec1-3ce7-42bc-ad18-e121aad7e43b
ys = values(freqs_sorted) |> collect

# ╔═╡ 023bec11-f5da-4cea-b75e-3aeae525c629
xs = keys(freqs_sorted) |> collect

# ╔═╡ 0f25a00c-1a80-495b-841b-fe6885710a2d
if isempty(xs) 
else
	plot(
...
# ╔═╡ 1722f0f9-94ba-4bd4-babc-8bb935f7658c
html"""
<br/><br/><br/><br/><br/>
<br/><br/><br/><br/><br/>
"""
...
# ╔═╡ 2619274c-1397-499d-a1ca-888183002396
"""Tidy up text by removing punctuation and making all lowercase."""
function tidyup(txt)
		alphas = filter(c -> ! ispunct(c), txt)
		map(c -> lowercase(c), alphas)
end

# ╔═╡ ee83b946-8351-4fc0-9d03-058a0769d429
tidytext = tidyup(fulltext)
...
manifest_format = "2.0"
project_hash = "15e7d8e1e5edd7def54631e4b475cda2501e14ab"
