...
# ╔═╡ a97693e6-d25c-11ee-14a9-b7bf04070cb5
begin
	using PhyloNetworks
	using CSV, DataFrames
end

# ╔═╡ 26972052-0b93-46b7-b7ac-9bbd01cdb172
csvfile = joinpath(dirname(pathof(PhyloNetworks)), "..","examples","Swadesh.csv");

# ╔═╡ 982d7974-0372-4c28-a1fc-5df8e94beced
csvsrc = CSV.File(csvfile)

# ╔═╡ 755ed0f7-e38c-41a9-b31d-dbd6883fd887
dat = DataFrame(csvsrc);

# ╔═╡ e9ff276c-280e-42e8-b426-4970e063830a
...
manifest_format = "2.0"
project_hash = "6f49db3cd3f6f0776e09e45482ee90b810e8a6a4"
