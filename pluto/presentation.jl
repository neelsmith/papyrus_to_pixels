...
# ╔═╡ 141854c0-fc09-11ee-09ae-6545601fd514
...
Pluto has a built-in `present` button (illustrated immediately above this cell)!  

- in a separate cell, paste  in the following contents:

    `html"<button onclick='present()'>present</button>"`

- it's a toggle: click it go enter/exit slide-show mode
...
- a [10-minutes tutorial](https://commonmark.org/help/tutorial/)
- Julia's [markdown documentation](https://docs.julialang.org/en/v1/stdlib/Markdown/) (including some extensions to CommonMark)
"""
...
md"""
The `PlutoUI` package defines a bunch of useful widgets that assign (or "bind") the result of a user's action to a Julia variable.
"""

# ╔═╡ 2686af13-960d-4f2e-961b-58b40b92b5d3
md"""!!! note "Learn more"

    See a sample notebook illustrating [all the basic widgets](https://featured.plutojl.org/basic/plutoui.jl)
"""

# ╔═╡ 2fbb715f-8b35-4d7c-9a91-6c9d9db4fcf1
...
md"""The `PlutoUI` package also includes a `TableOfContents` function that is very useful for navigation in long slideshows.
...
md"""!!! note "Data for this example"
    ...
    At the end of this notebook, I compute a word list for the Declaration of Independence in a variable named `words`, and count the number of times each word occurs in the variable `counts`.
"""
...
manifest_format = "2.0"
project_hash = "dbee00baf404a12f21a2bc34742cfc9d0a14c086"
